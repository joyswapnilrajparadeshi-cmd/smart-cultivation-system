...
<div class="main">
    <div class="header">
        <h1>
            ...
            <?php echo $translations['hello'] ?? 'Hello'; ?>, <?php echo htmlspecialchars($admin['fullname']); ?>
        </h1>
        <div class="welcome">
            <i class="fas fa-badge-check"></i> <?php echo $translations['role_admin'] ?? 'Role: Admin'; ?>
        </div>
    </div>
    ...
    <div class="cards">
        ...
        <a href="farmers_admin.php" class="card">
            <i class="fas fa-users"></i>
            <h3><?php echo $translations['farmer_management'] ?? 'Farmer Management'; ?></h3>
        </a>
    </div>
</div>
