...
const apiKey = "6c73e3b2bacf61829c0efec5a0a848d4";
...
function fetchWeatherAndRender(){
    ...
    const url = `https://api.openweathermap.org/data/2.5/forecast?q=${encodeURIComponent(district)},IN&appid=${apiKey}&units=metric`;
