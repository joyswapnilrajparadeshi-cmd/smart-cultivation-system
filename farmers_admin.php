...
if(isset($_GET['lang'])){
    ...
    header("Location: farmers_admin.php");
    exit;
}
...
<html>
<head>
<title><?php echo $translations['farmer_management'] ?? 'Farmer Management'; ?> | <?php echo $translations['admin'] ?? 'Admin'; ?></title>
...
<div class="dashboard">
    ...
    <div class="main">
        ...
        <div class="header">
            <h1>
                <i class="fas fa-users"></i>
                <?php echo $translations['farmer_management'] ?? 'Farmer Management'; ?>
            </h1>
        </div>

        <div class="search-container">
            <input type="text" id="search" placeholder="<?php echo $translations['search_farmers'] ?? 'Search farmers by Name, Email, Mobile, District...'; ?>">
        </div>
        ...
        <table id="farmersTable">
            <thead>
                <tr>
                    ...
                    <th><?php echo $translations['full_name'] ?? 'Full Name'; ?></th>
                    <th><?php echo $translations['email'] ?? 'Email'; ?></th>
                    <th><?php echo $translations['mobile'] ?? 'Mobile'; ?></th>
                    <th><?php echo $translations['district'] ?? 'District'; ?></th>
                    <th><?php echo $translations['state'] ?? 'State'; ?></th>
                    <th><?php echo $translations['registered'] ?? 'Registered'; ?></th>
                    <th><?php echo $translations['crops'] ?? 'Crops'; ?></th>
                    <th><?php echo $translations['notifications'] ?? 'Notifications'; ?></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    $statusText = ($status == 'active') ? ($translations['active'] ?? 'Active') : ($translations['inactive'] ?? 'Inactive');
                                ?>
                                ...
                                <div class="action-buttons">
                                    ...
                                    <a href="toggle_farmer.php?id=<?php echo $f['id']; ?>">
                                        <button class="action-btn <?php echo ($status == 'active') ? 'btn-deactivate' : 'btn-activate'; ?>">
                                            ...
                                            <span><?php echo ($status == 'active') ? ($translations['deactivate'] ?? 'Deactivate') : ($translations['activate'] ?? 'Activate'); ?></span>
                                        </button>
                                    </a>

                                    <a href="delete_farmer.php?id=<?php echo $f['id']; ?>" onclick="return confirm('<?php echo $translations['delete_confirmation'] ?? 'Delete this farmer?'; ?>')">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="11" style="text-align:center; padding: 40px 20px; color: var(--text-light);">
                            ...
                            <p style="font-size: 16px; font-weight: 500;"><?php echo $translations['no_farmers_found'] ?? 'No farmers found.'; ?></p>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
