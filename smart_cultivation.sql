-- Do NOT create database on InfinityFree
-- Database already exists: if0_41196114_scs

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

DROP TABLE IF EXISTS crop_notifications;
...
-- CROP NOTIFICATIONS TABLE
CREATE TABLE crop_notifications (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL,
    crop_name VARCHAR(100) NOT NULL,
